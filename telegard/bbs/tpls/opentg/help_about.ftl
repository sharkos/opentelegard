...
${color.white}                      OpenTelegard/2 Operating SubSystem
${color.reset}         Copyright (c) 2008-2011, Chris Tusa & LeafScale Systems, LLC
${color.brightyellow}                           http://www.telegard.org

${color.darkgray}================================================================================
${color.cyan}OpenTelegard was made possible by open-source software:
